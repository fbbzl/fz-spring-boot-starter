...
public class ValidationMessageConfiguration
{
    ...
    private static final String BASENAME = "io.github.fbbzl.starter.webflux.validation.ValidationMessages";

    @Bean
    @Order(Ordered.HIGHEST_PRECEDENCE)
    public ValidationConfigurationCustomizer webFluxValidationMessageCustomizer(ApplicationContext applicationContext)
    {
